  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bg-primary)' }}>
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-32 relative">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl leading-relaxed mb-10 max-w-lg" style={{ color: 'var(--text-muted)' }}>
                Yeşil çekirdek stoğundan üretim profillerine, toptan siparişlerden productionBatch seanslarına — üretim atölyenizin tüm ritmini tek platformda yönetin.
              </p>
          ...
          <div className="max-w-6xl mx-auto px-6 py-20">
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              {[
                {
                  num: '01',
                  title: 'Üretim Profilleri',
                  desc: 'Charge, drop sıcaklığı ve süreyi kaydedin. Her çekirdek için tekrarlanabilir üretim reçeteleri oluşturun.',
                },
                {
                  num: '02',
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          >
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-4" style={{ color: 'var(--cream)' }}>
              Üretim atölyenizi dijitalleştirmeye hazır mısınız?
            </h2>
            <p className="mb-8 max-w-md mx-auto" style={{ color: 'var(--text-nav-muted)' }}>
              Ücretsiz kayıt olun ve artizan fırın atölyenizi dakikalar içinde yönetmeye başlayın.
            </p>
      ...
      <footer className="border-t py-8 text-center text-sm" style={{ borderColor: 'var(--border-color)', color: 'var(--text-muted)' }}>
        FirinEmek &copy; 2026 — Fırın üretim atölyesi yönetim platformu
      </footer>
    </div>
  );
}
