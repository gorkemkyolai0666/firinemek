...
export default function LoginPage() {
  ...
  const fillDemo = () => {
    setEmail('demo@kadikoyfirin.com');
      ...
      >
        ...
        <div className="max-w-md relative">
          ...
          <h2 className="font-display text-4xl font-bold mb-4 leading-tight" style={{ color: 'var(--cream)' }}>
            Üretim atölyenizin dijital merkezi
          </h2>
          <p className="text-lg leading-relaxed" style={{ color: 'var(--text-nav-muted)' }}>
            Yeşil çekirdek stoğundan üretim profillerine, toptan siparişlerden productionBatch seanslarına — FirinEmek ile atölyenizi tek platformda yönetin.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8" style={{ background: 'var(--bg-primary)' }}>
        <div className="card w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-sm mt-2" style={{ color: 'var(--text-muted)' }}>Üretim atölyesi hesabınıza giriş yapın</p>
          </div>
